...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    $buyer = new Buyer();
    $id = $_SESSION['faujihouse_userid'];
    $result =  $buyer->create_buyer($id, $_POST);
...
<body>
                     ...
                     <div class="container" style="position:reative; margin-top:3rem;">
                        <div class="title">Begin to Buy / Rent here..</div>
                        <br>
                        ...
                        <div class="content">
                            ...
                            <div class="gender-details" style=" position: relative; top :-10%;" required>
                                ...
                                <span class="gender-title" style="font-size:1.5rem;">Property Details</span>
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="input-box">
                                        <span class="details">Name of Property</span>
                                        <input name="property_name" type="text" placeholder="Enter property name" required>
                                    </div>
                                    <div class="input-box">
                                ...
                                <div class="gender-details">
                                    <input type="checkbox" name="home_loan" id="dot-6" value="home loan" >
                                    <input type="checkbox" name="site_visit" id="dot-7" value= "visit website">
                                    ...
                                    <div class="category">
                                        ...
                                        <label for="dot-7">
                                            ...
                                            <span >I am interested in site visits.</span>
                                        </label>  &nbsp; &nbsp; &nbsp; &nbsp;
                                        <label for="dot-8">
                                ...
                                <div class="gender-details">
                                    ...
                                    <span class="gender-title">By when you are planning to buy / rent the property?</span>
                                    <div class="category">
                                        <label for="dot-1">
                                        ...
                                        <label for="dot-3">
                                            ...
                                            <span class="gender">more than 6 months</span>
                                        </label>
                                    </div>
                                </div>

                                <div class="button">
                                  <a href="testbuy.php"><input type="submit" value="Submit"></a>  
                                </div>
                            </form>
                        </div>

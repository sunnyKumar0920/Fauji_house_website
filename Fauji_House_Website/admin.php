  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side" style="position:realtive; width:50rem;">
      ...
      <div class="recent-sales box">
          <div class="title">Recent Project Sales</div>
          <div class="sales-details">
            <ul class="details">
            <?php
                $sql = 'SELECT *  FROM project_buy ';
                 ...
                 $project_buy = mysqli_fetch_all($result , MYSQLI_ASSOC);
                 mysqli_free_result($result);
                 mysqli_close($conn);
            ?>
              <li class="topic">Date</li>
              <?php foreach($project_buy as $buyers) {?>
          ...
          <ul class="details">
            ...
            <?php foreach($project_buy as $buyers) {?>
              <li><?php  echo htmlspecialchars($buyers['project_name'] ); ?></li>
              <?php } ?>
        ...
        <div class="recent-sales box">
          <div class="title">Recent Property Sales</div>
          <div class="sales-details">
            <?php
                //  $sql = 'SELECT * FROM buyer ORDER BY created_at';
                $sql = 'SELECT date, first_name , last_name , property_name , price FROM buyer ';
            ...
            <ul class="details">
              ...
              <?php foreach($buyer as $buyers) {?>
                ...
                <!-- <?php $wop= $row['date']; print date ("Y/M/d H:i:s",strtotime($wop)) ?> -->

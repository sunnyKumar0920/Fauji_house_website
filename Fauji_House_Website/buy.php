...
<body>
            ...
            <div class="budget"
                ...
                <div class="wrapper-area">
                    ...
                    <div class="container-area">
                        ...
                        <input class="input" type="range" min="0" max="50000" value="300" id="slider-1"
                            oninput="slideOne()">
                        <input class="input" type="range" min="0" max="50000" value="700" id="slider-2"
                            oninput="slideTwo()">
                    </div>
                </div>
                <script>
    ...
    <!-- <script type="text/javascript">
     const toggleBtns = document.querySelectorAll('.box');

  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <?php
                      $query_buy = 'SELECT COUNT(id) AS count FROM project_query ';
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box" style="width:80%;">
          <div class="title"> All Query Request </div>
          <div class="sales-details">
            <?php
                //  $sql = 'SELECT * FROM buyer ORDER BY created_at';
                $sql_buyer = 'SELECT * FROM project_query ';
          ...
          <li class="topic">Time</li>
              <?php foreach($buyer as $buyers) {?>
                ...
                <li><?php  $wop= htmlspecialchars($buyers['date'] ) ; print date ("H:i:s",strtotime($wop)) ?></li>          
             <?php } ?>

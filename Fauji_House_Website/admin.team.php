    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <?php
                        $query_buy = 'SELECT COUNT(id) AS count FROM team_memberi ';
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Total Payment  <span style="color:grey; font-size:0.7rem;">(ths.)</span></div>
            <?php
                        $query_buy = 'SELECT SUM(salary) AS sum FROM team_memberi ';
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box" style="width:100%">
          ...
          <ul class="details">
            <li class="topic">Salery <span style="color:grey; font-size:0.7rem;">(ths.)</span></li>
            <?php foreach($buyer as $buyers) {?>
              <li>&#8377;<?php  echo htmlspecialchars($buyers['salary'] ); ?></li>
              <?php } ?>
          </ul>
          ...
          <ul class="details">
            ...
            <?php foreach($buyer as $buyers) {?>
              <li><?php  echo htmlspecialchars($buyers['age'] ); ?></li>
              <?php } ?>
          </ul>
          <ul class="details">
